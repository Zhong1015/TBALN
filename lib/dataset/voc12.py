...
class Voc12Dataset(data.Dataset):
    def __init__(self, 
        img_dir='/root/nas-private/Dataset/VOCdevkit/VOC2012/JPEGImages', 
        anno_path='/root/nas-private/Dataset/VOCdevkit/VOC2012/ImageSets/Main/trainval.txt', 
        transform=None, 
        labels_path='/root/nas-private/Dataset/VOCdevkit/VOC2012/Annotations',
        dup=None,
    ):
        self.dup = dup
        self.img_names  = []
