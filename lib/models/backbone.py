...
def get_model_path(modelname):
    ...
    pretrained_dir = '/root/nas-private'
    PTDICT = {
        ...
        'Convnext_v2_base': 'convnextv2_base_22k_384_ema.pt'
    }
...
def build_backbone(args):
    ...
    if args.backbone in ['swin_B_224_22k', 'swin_B_384_22k', 'swin_L_224_22k', 'swin_L_384_22k']:
        ...
        backbone.cls_token = False
        del backbone.head
    elif args.backbone in ['convnextv2_base']:
        ...
        backbone=timm.create_model(args.backbone,pretrained=True,num_classes=0, global_pool="",pretrained_cfg=pretrained_cfg)
